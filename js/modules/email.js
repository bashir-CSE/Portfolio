...
export function handleContactFormSubmit(e, config, elements) {
  ...
  try {
    ...
    elements.formMessage.innerHTML = `<div class="p-4 bg-red-100 border border-red-400 text-red-700 rounded"><i class="fas fa-exclamation-circle mr-2"></i>Unexpected error occurred. Please try again.</div>`;
    elements.formMessage.classList.remove("hidden");
    elements.btnText.classList.remove("hidden");
    elements.btnLoading.classList.add("hidden");
    elements.submitBtn.disabled = false;
